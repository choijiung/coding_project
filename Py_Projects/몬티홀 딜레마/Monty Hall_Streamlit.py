...
with tab1:
    # image = Image.open("/Users/Jiung/coding/Py_Projects/몬티홀 딜레마/Monty_Hall_site_Image.png")
    ...
    if button:
        ...
        st.write("버튼을 눌러보세요")
with tab2:
    # image2 = Image.open("/Users/Jiung/coding/Py_Projects/몬티홀 딜레마/monty hall.png")
    st.header("코드보기")
    # st.image(image2, caption="코드")
    st.write("from random import *
import random
